  ...
  return (
    <section className="p-5 pt-5 bg-green-700 prose lg:prose-xl sm:p-10 md:pt-10 md:p-20 lg:px-32 xl:px-64">
      ...
      <p className="font-sans tracking-wide text-justify text-white">
        ...
        reprehenderit fugit. Incidunt quae ipsam error obcaecati adipisci.
        Fugiat reprehenderit repellat aspernatur obcaecati magnam? Doloremque
        delectus magnam doloremque dolore eos Inventore veritatis deleniti
        nesciunt enim ut. Natus ut enim laudantium illum voluptatem. Neque
        minima odit soluta atque quo? Debitis totam repellendus facere
        recusandae dignissimos Exercitationem nostrum sapiente id quasi ratione
        Vero minus itaque sit illum quasi voluptatibus possimus? Velit
        ...
        laborum similique dolores harum reprehenderit necessitatibus. Ad nostrum
        velit voluptate amet placeat voluptate molestias. Vero voluptatibus
        nostrum reiciendis quibusdam?
      </p>
    </section>
  );
};
